...
export function AccountTopMenu() {
  ...
  return (
    <div className="sticky top-0 z-[90] border-b border-black/5 bg-white">
                        ...
                        {notifications.map((n) => {
                          ...
                          return (
                            <button
                              ...
                              className="w-full rounded-2xl border-2 border-brand-emerald bg-white px-3 py-2.5 text-left hover:bg-emerald-100 transition-colors relative"
                            >
                          ...
                          <>
                            ...
                            {alerts.map((a) => (
                              <button
                                ...
                                className="w-full rounded-2xl border border-brand-emerald/20 bg-white px-3 py-2 text-left hover:bg-emerald-100 transition-colors"
                              >
                                <div className="flex items-start justify-between gap-2">
                                  <div className="min-w-0 flex-1">
