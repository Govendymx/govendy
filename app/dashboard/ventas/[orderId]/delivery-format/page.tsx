        ...
        <div id="printable-area" className="p-12">
          ...
          <div className="mb-8 flex items-center justify-between border-b border-gray-200 pb-6">
            <div className="flex items-center gap-3">
               <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-orange text-white font-bold text-xl print:text-black print:bg-transparent print:border print:border-black">
                 GP
               </div>
               <div>
