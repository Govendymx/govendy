                  ...
                  <div className="border-b border-black/5 bg-gray-50 px-4 py-3">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <Link
                        ...
                        className="rounded-xl bg-brand-orange px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:opacity-90"
                      >
                        Ver chat
                      </Link>
                    </div>
                        ...
                        <div>
                          ...
                          <div className="mt-2 space-y-1 text-sm">
                            <div>
                              ...
                              {buyerId ? (
                                <Link href={`/perfil/${buyerId}`} className="font-semibold text-brand-orange hover:underline">
                                  {buyerName}
                                </Link>
                              ) : (
