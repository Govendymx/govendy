...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className={`sticky z-[39] bg-brand-onyx text-brand-volt transition-all ${userName ? 'top-[52px]' : 'top-0'}`}>
      ...
      <header className={`sticky z-40 border-b border-black/5 bg-white transition-all ${userName ? 'top-[92px]' : 'top-[40px]'}`}>
